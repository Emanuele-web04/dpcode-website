...
<Callout type="warn" title="Do not delete data as a first step">
  Replacing the application bundle and deleting Synara’s local data are different operations. As a rule, reinstall the application first. Preserve repositories, uncommitted changes, task evidence, and any data directory before considering destructive cleanup.
</Callout>
