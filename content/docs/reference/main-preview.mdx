...
<Callout type="info" title="Preview track: main">
  Synara ships a stable desktop release. This page follows the active `main` branch and gives an early look at capabilities newer than stable 0.5.5; those details can change before the next release.
</Callout>
...
<DocsScreenshot
  src="/docs-media/settings-integrations-light.png"
  alt="Integrations settings page showing the empty state before any external MCP app is connected"
  width={1440}
  height={900}
  provenance="real"
  caption="The Integrations settings page before any external agent is connected."
/>
...
The Appearance settings page controls the desktop theme and related display preferences, in both light and dark modes:

<DocsScreenshot
  src="/docs-media/settings-appearance-light.png"
  alt="Appearance settings page in light theme with theme and display options"
  width={1440}
  height={900}
  provenance="real"
  caption="Appearance settings in light theme."
/>

<DocsScreenshot
  src="/docs-media/settings-appearance-dark.png"
  alt="Appearance settings page in dark theme with theme and display options"
  width={1440}
  height={900}
  provenance="real"
  caption="Appearance settings in dark theme."
/>
