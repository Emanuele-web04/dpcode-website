...
<Callout type="warn" title="External MCP is local, scoped authority">
  Pairing another client grants it real ability to create Synara work. Keep project access and execution permissions narrow, and revoke integrations that are no longer needed.
</Callout>
