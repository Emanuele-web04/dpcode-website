...
<Callout type="warn" title="Remote actions are shared state">
  A merge, close, reopen, or comment affects other collaborators and automation. Verify the repository, pull request, account, and current head before confirming it.
</Callout>
