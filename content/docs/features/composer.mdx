...
<Callout type="info" title="Terminals and previews">
  What the agent produces flows back through the same panel system — terminals, browser previews, diffs, and generated images render beside the conversation. See [Core concepts](/docs/getting-started/core-concepts).
</Callout>
