...
| Grok | Your configured Grok agent runtime and access |
...
<Callout type="info" title="Provider-specific guides will follow">
  This page explains the shared model. Dedicated provider pages can document exact installation, authentication, diagnostics, capabilities, and limitations for each runtime.
</Callout>
