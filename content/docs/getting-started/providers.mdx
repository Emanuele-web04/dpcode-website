---
title: Providers
description: Connect the agent runtimes and subscriptions you already use with Synara.
---

Synara is the command center around your providers. It does not sell a separate model subscription or replace the provider's own authentication—it gives the runtimes you already trust a better operating surface.
