...
<DocsScreenshot
  src="/docs-media/settings-general-light.png"
  alt="General settings page with application preferences and workspace options"
  width={1440}
  height={900}
  provenance="real"
  caption="The General settings page holds Synara's application-level preferences."
/>
