...
export default function ClosingCTA({
  ...
  return (
    <section className="border-t border-[var(--divide)] bg-[var(--page-bg)]">
      <div className="mx-auto max-w-[720px] px-4 py-24 text-center sm:px-6 sm:py-32">
        ...
        <p className="mx-auto mt-6 max-w-[480px] text-[13px] leading-[1.6] text-[var(--text-secondary)] sm:text-[14px]">
