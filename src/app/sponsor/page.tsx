      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 pt-10 pb-20 sm:px-6 sm:pt-14">
        <header>
          ...
          <p className="mt-3 max-w-3xl text-[13.5px] leading-[1.65] text-[var(--text-secondary)]">
            Synara Desktop is open source under the MIT license, with no paid
            tier, no account, and nothing held back behind a subscription. It&apos;s
            maintained by me, with help from some kind developers in the open
            source community. If it saves you time, sponsoring
            is the most direct way to keep it moving — every tier below runs
            through GitHub Sponsors, so billing, receipts, and cancellation stay
            entirely on GitHub.
          </p>
        ...
        <section className="mt-12">
          ...
          <p className="mt-2 max-w-3xl text-[13px] leading-[1.65] text-[var(--text-secondary)]">
            Thank you — genuinely. This list is updated by hand as sponsorships
            come in.
          </p>
        ...
        <section className="mt-12">
          ...
          <div className="mt-4 space-y-5">
            <QA question="Does sponsoring unlock features?">
              No. Synara is MIT-licensed and every feature is free for everyone,
              sponsor or not. Sponsorship funds the work — it doesn&apos;t buy
              access.
            </QA>
            <QA question="Can I sponsor as a company?">
              Yes. GitHub Sponsors supports paying from an organization account,
              and invoices come from GitHub. Logo placement and a link come with
              the $149 and $499 tiers, whoever is sponsoring.
            </QA>
            <QA question="Can I give a one-off amount instead?">
              Yes. Switch to the One-time tab on GitHub and enter any amount you
              like — there are no fixed one-time tiers, so a one-off contribution
              always shows up as a custom amount.
            </QA>
            <QA question="How do I get my name or logo listed?">
              Sponsor at $15 or above and your name goes on the sponsor wall;
              from $49 up — monthly or one-time — it goes under Top donors. For
              logo placement at $149 and above, send me the asset and the link
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-[var(--divide)] pt-8 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-[12px] text-[var(--text-tertiary)]">
            Not able to sponsor? Starring the repo and telling someone about
            Synara genuinely helps too.
          </p>
          <Link
            href="/install"
            className={ctaButtonClass({ variant: "secondary", width: "fit" })}
          >
            Download Synara
